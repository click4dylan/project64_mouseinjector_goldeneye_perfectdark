...
typedef struct
{
    ...
    int (*init)(void);
    void (*quit)(void);
    const char *(*name)(unsigned int index, unsigned int iskeyboard);
...
const char *ManyMouse_DeviceName(unsigned int index, unsigned int iskeyboard);
